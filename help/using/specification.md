...
1. **[AEM Extensions](https://experienceleague.adobe.com/en/docs/experience-manager-htl/content/aem-extensions)** - AEM builds on top of the `Sling` HTL Scripting Engine to offer developers convenient features specific to AEM. These extensions are documented as part of this documentation set.
